...
public class ShufflePlayerMovement : MonoBehaviour
{
    ...
    {
        inputVec = playerInput.ShufflePlayer.Movement.ReadValue<Vector2>();
    }
    ...
    {
        if (playerInput.ShufflePlayer.Jump.WasPressedThisFrame() && isOnGround)
        {
