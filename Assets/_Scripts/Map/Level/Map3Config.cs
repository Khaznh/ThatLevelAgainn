...
public class Map3Config : MapConfig
{
    ...
    public void PlayButtonDownLogic(Animator animator)
    {
    ...
    public void PlayGateDownLogic(Animator animator, BoxCollider2D gateCollider)
    {
        if (isGateOpen)
        {
            return;
